...
const firebaseConfig = {
  ...
  authDomain: process.env.REACT_APP_FIREBASE_AUTH_DOMAIN || 'sample-table-7eefa.firebaseapp.com',
  projectId: process.env.REACT_APP_FIREBASE_PROJECT_ID || 'sample-table-7eefa',
  storageBucket: process.env.REACT_APP_FIREBASE_STORAGE_BUCKET || 'sample-table-7eefa.firebasestorage.app',
